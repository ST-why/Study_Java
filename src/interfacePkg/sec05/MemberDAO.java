...
public class MemberDAO implements IMemberDAO {
    ...
    public void insertMember(MemberDTO dto) {
        ...
        System.out.println(id + "님의 회원가입아 완료되었습니다.");
    }
    ...
    public MemberDTO selectMember(String memId) {
        ...
        MemberDTO dto = new MemberDTO("abc123","abcdpwd", "홍길동", "01012341234","서울");
        return dto;
    }
    ...
    @Override
    public ArrayList<MemberDTO> getMemberByName(String nameStr) {
        return null;
    }
}
