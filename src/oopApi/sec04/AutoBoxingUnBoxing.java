...
public class AutoBoxingUnBoxing {
    ...
    public static void main(String[] args) {
        ...
        // 자동 박싱
        Integer obj = 100; // 100 기본값이 obj가 참조하게된 객체의 필드로 저장
        ...
        int result = obj + 100; //obj 객체와 기본값의 연
        System.out.println(result);

        //래퍼 클래스는 Static 메소드로 문자열을 기본 타입값으로 변환 하는 기능을 갖고 있음
        //parseXXX()
        ...
        //래퍼 클래스의 내부 값 비교: == != 연산자 사용불가, 언박싱 비교하거나 equals() 사용
